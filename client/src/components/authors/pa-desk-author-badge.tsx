...
export function PaDeskAuthorBadge({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "flex h-full w-full flex-col items-center justify-center rounded-full border border-border/80 bg-gradient-to-br from-muted/80 to-muted/40 px-2 py-2 text-center shadow-sm",
        className,
      )}
      aria-label="PA Media syndicated desk"
    >
      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 ring-1 ring-primary/15">
